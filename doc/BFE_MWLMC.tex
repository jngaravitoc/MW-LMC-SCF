...
\title{Hunting for the Dark Matter Wake Induced by the Large Magellanic Cloud}
...
\author[0000-0001-7107-1744]{Nicolas Garavito-Camargo}
...
\author[0000-0002-1343-134X]{Laura L. Watkins}
...
\section{methods}
\section{results}
\subsection{Density and potential shape at t=0}
\subsection{BFE as at t=0}
What the individual terms mean.How do they relate with the substructure that we
identify in paper I.


\subsection{BFE as a function of time}
What is the time evolution of the BFE expansion. How well this method recover
the full N-body simulation.

\subsection{Orbit calculations from GC and satellite galaxies}
How orbits are changed between the BFE, MW static and MW+LMC no N-body. Why we
need the BFEs?
